        ...
        <mdui-layout>
            ...
            <mdui-navigation-drawer open class="index-navigation-drawer" style="color: gray;">
                <mdui-list>
                    ...
                    <mdui-list-item class="btn-join" onclick="javascript:window.location.href='./join.php'">加入</mdui-list-item>
                </mdui-list>
            </mdui-navigation-drawer>

            <mdui-layout-main class="index-layout-main" style="min-height: 300px; margin-left: 27px;">
                <h1><?php echo $name;?> - 加入</h1>
                <br>
                <form action="./core/joinapi.php" method="get" class="">
                    <div class="row g-3 align-items-center" style="width: 600px;">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Name" name="name" style="width: 500px;" required>
                        </div>
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Domain" name="domain" style="width: 500px;" required>
                        </div>  
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Author" name="author" style="width: 500px;" required>
                        </div>  
                        <div class="col">
                            <input type="text" class="form-control" placeholder="CreateDate" name="createDate" style="width: 500px;" required>
                        </div>  
                        <div class="col">
                            <input type="text" class="form-control" placeholder="ICPNumber" name="icpNumber" style="width: 500px;" required> <!--ICP号可能被修改为空, 所以还要 required.-->
                        </div>  
                        <div class="col">
